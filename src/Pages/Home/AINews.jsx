...
function AINews() {
  ...
  return (
    <div className={isDarkMode ? 'dark' : ''}>
      ...
      <div className={`w-full h-screen p-4 ${isDarkMode ? 'bg-gray-900' : 'bg-white'}`}>
      <iframe
        src="https://www.artificialintelligence-news.com/"
        title="AI News"
        className={`w-full h-full rounded-xl shadow-lg ${isDarkMode ? 'border-purple-500' : 'border-pink-400'}`}
      />
    </div>
